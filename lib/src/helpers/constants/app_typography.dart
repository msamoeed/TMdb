...
class     AppTypography {
  ...
  static final primary = _FontStyle(
    ...
    heading34: _poppins.copyWith(
      color: AppColors.textBlackColor,
      fontSize: 34,
      fontWeight: FontWeight.bold,
    ),
    heading22: _poppins.copyWith(
      color: AppColors.textBlackColor,
      fontSize: 22,
      fontWeight: FontWeight.bold,
    ),
    title20: _poppins.copyWith(
      color: AppColors.textBlackColor,
      fontSize: 20,
    ...
    label11: _poppins.copyWith(
      color: AppColors.textBlackColor,
      fontSize: 11,
    ),
  );

    static final darkprimary = _FontStyle(
    fontFamily: _poppins.fontFamily,
    heading34: _poppins.copyWith(
